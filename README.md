...
region, category, order_date: По этим столбцам можно провести группировку и понять какие регионы самые активные, какие категории продаются чаще всего, в какие месяцы больше всего заказов<br>
order_date: Благодаря этой колонке можно так же выяснить тенденции продаж с течением времени и динамику продаж. Строить прогнозы спроса на основе исторических данных<br>
region: Можно оптимизировать маркетинговые кампании на основе региональных особенностей. Анализировать логистические затраты по регионам.<br>
product_name: Определять наиболее популярные продукты. Создать рекомендации по продуктам на основе предпочтений клиентов.<br>
category: Сегментировать клиентов по категориям покупок.<br>
total_amount: Оценка общей выручки без учёта скидок. Выявление клиентов с высокими суммами заказов.<br>
discount_percent: Анализ эффективности скидочных кампаний (влияют ли скидки на объём продаж). Выявление продуктов, которые часто покупаются со скидкой.<br>
final_amount: Подсчёт фактической выручки после применения скидок. Анализ доходности заказов. Оценка влияния скидок на прибыльность<br>
## Завершение
